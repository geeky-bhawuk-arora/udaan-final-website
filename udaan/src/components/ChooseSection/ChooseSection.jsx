        ...
        <div className='row g-4'>
          <div className='col-lg-4'>
            <Card className='d-flex align-items-center border-0 h-[300px] 
                             hover:scale-105 hover:shadow-xl hover:shadow-blue-400 
              ...
              <Card.Body className='flex flex-col justify-between h-full'>
                <Card.Title className='text-center text-capitalize mb-3 italic text-xl font-bold'>
                  8+ Times Winner
                </Card.Title>
                <Card.Text className='italic text-justify text-base h-[120px] overflow-y-auto'>
                  We are proud to announce that our team has triumphed in 8 Aeromodelling Events across IITs and NITs!
                </Card.Text>
              </Card.Body>
            </Card>
          </div>
          ...
          <div className='col-lg-4'>
            <Card className='d-flex align-items-center border-0 h-[300px] 
              ...
              <Card.Body className='flex flex-col justify-between h-full'>
                ...
                <Card.Text className='italic text-justify text-base h-[120px] overflow-y-auto'>
                  We conduct engaging aeromodelling workshops, offering hands-on experience in building and flying model aircraft. Learn the principles of aerodynamics and practical skills to explore the fascinating world of aviation.
                </Card.Text>
              </Card.Body>
            </Card>
          </div>
          ...
          <div className='col-lg-4'>
            <a href="https://maps.app.goo.gl/FBeR3GoaMjd61p936" className='text-decoration-none'>
              <Card className='d-flex align-items-center border-0 h-[300px] 
                               hover:scale-105 hover:shadow-xl hover:shadow-blue-400 
                               transition-all duration-300 p-4'>
                <div className='mt-3'>
                ...
                <Card.Body className='flex flex-col justify-between h-full'>
                  ...
                  <Card.Text className='italic text-justify text-base h-[120px] overflow-y-auto'>
                    Poornima College Of Engineering, Sitapura, Jaipur, 302022
                  </Card.Text>
                </Card.Body>
              </Card>
            </a>
